...
\end{verbatim}
    ...
    \label{sec:lifting_introduction}
        ...
        One can see that the code generated for the expression \texttt{vₛ 5 ⟫ₛ vₛ 7} is generated twice.
        ...
        some functor. This makes the recursive positions explicit and will later allow us to label them. Because \textt{Bytecode} 
        ...
        %correctness for graph structure
