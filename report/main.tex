...
correctG = lift correctT
        ...
        To actually instantiate the \texttt{Lifting} module, one needs to supply a proof of the \textt{unravelLemma} tailored for the specific functor at hand. 
        Unfortunately, we didn't manage to supply a full proof of this lemma for our \textt{BytecodeF} functor. There is only tiny hole left open, but 
